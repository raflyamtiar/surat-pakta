...
const faqData = {
  ...
  Lokasi:
    "Jl. Pemuda No.29 A, RT.01/RW.06, Tanah Sareal, Kec. Tanah Sereal, Kota Bogor, Jawa Barat 16161",
  Kontak:
    "Email: bpmsph@pertanian.go.id, \nTel/Fax: +62-251-8377111, +62-251-8353712",
  ...
  setTimeout(() => {
    ...
    if (selectedData) {
      if (typeof selectedData === "object") {
        ...
        createChatMessage(selectedData.replace(/\n/g, "<br>"), "incoming");
      } else {
        createChatMessage("Maaf, tidak ada jawaban yang sesuai.", "incoming");
      }
      document.getElementById("startBtn").style.display = "block";
    } else {
      createChatMessage("Maaf, tidak ada jawaban yang sesuai.", "incoming");
